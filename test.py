...
def read_data():
    ...
    # test_file_face  = S7 + '/faces/test/no_gender/English_test_faces.csv'
    # test_file_voice = S7 + '/voices/test/no_gender/English_test_voices.csv'
    ...
    S7 = '/home/swapnilkhandoker/Bachelor_Thesis/project/utils/stage7_feature_extraction/mavceleb_baseline/features_v1x'  
    test_file_face  = S7 + '/faces/valid/gender/English_valid_faces.csv'  
    test_file_voice = S7 + '/voices/valid/gender/English_valid_voices.csv'  
...
def test(face_test, voice_test):
    ...
    checkpoint = torch.load(FLAGS.ckpt, weights_only=False)
    model.load_state_dict(checkpoint['state_dict'])
    print("=> loaded checkpoint '{}' (epoch {})"
